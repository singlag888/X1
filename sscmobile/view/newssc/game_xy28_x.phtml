...
<header id="firstHeader" class="headerbg">
    ...
    <span class="headtetle"><?php echo $lottery['cname'] ?>[信]
...
<div class="top-box">
    <div class="NumberBox5">
        ...
        <div class="playTimer thisIssueInfo" id="thisIssueInfo">
            ...
            <span class="Timer fix"><div class="thisIssueRemainTime"
    ...
    <div class="Gamepart">
        ...
        <div class="PlayCenter">
            <div class="playControlBox">
                ...
                <div class="clear"></div>
                <!-- 选定按钮 -->
                <div class="FatherCodeBtn01" style="height: auto;">
                    <div class="xfootbox01 important_font_box">
                    ...
                    <div class="xfootbox02">
                        ...
                        <!-- <button class="confirmBtn_g" id="selectCodeBtn" style="display: none;">投注</button> -->
                        <!-- <button id="confirmBtn_g" style="display: none;">投注1</button> -->
                    </div>
                </div>
            ...
            <div class="bonusSlide fix">
                ...
                <div class="fh gameLeftLI" id="singleInfo">
                    <div class="MultiplePattern" id="totalSingleInfo">
                        ...
                        <a href="javascript:void(0);" id="jiao">2角</a><a href="javascript:void(0);" id="fen">2分</a>
                        <a href="javascript:void(0);" id="yuanYi">1元</a><a href="javascript:void(0);" id="jiaoYi">1角</a>
                        <a href="javascript:void(0);" id="li">2厘</a></span>
                    </div>
                    <div class="multiples">
...
<script type="text/javascript" src="<?php echo $imgCdnUrl ?>/js/game/min/game_xy28_x.min.js?v=<?php echo $html_version; ?>"></script>
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".methodGroupLI dd").live("click", function () {
            ...
            $('p.GameText').removeClass('DisplayNone').addClass('DisplayBlock');
            $(".wanfa_bg").removeClass("DisplayBlock").removeClass('DisplayNone');
        });
