...
<html>
    ...
    <body>
        ...
        <header class="headerbg">
         ...
         <div class="top-box">
            <div class="NumberBox5" id="NumberBox5" style="margin-top: 1.875rem;">
                <div class="Lottmain">
                    <div class="GameName">
    ...
    <script src="<?php echo $imgCdnUrl ?>/js/game/min/game_ssc.min.js?v=<?php echo time(); ?>" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        $(document).ready(function(){
           $(".methodPopStyle li").each(function(i){
            ...
            // 默认玩法文本一次
            if($('.headtetle').html()==='体彩P3P5[官]'||$('.headtetle').html()==='福彩3D[官]'){
                $(".GameText span").html('定位胆');
            }else{
            ...
            //机选
            $(".selectRandomBtn").click(function(){
                $(".NumberBox5").addClass("DisplayNone").removeClass("DisplayBlock");
                $(".moreGame").addClass("DisplayNone").removeClass("DisplayBlock");
                $(".GameBoxall").addClass("DisplayNone").removeClass("DisplayBlock");
                $(".betPage").addClass('DisplayBlock').removeClass("DisplayNone");
