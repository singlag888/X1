...
<html>
    ...
    <body>
       <?php if ($lottery['lottery_type'] == 6): ?>
        ...
        <header id="firstHeader" class="headerbg">
            ...
            <span class="headtetle">香港⑥合彩<span class="title_x">[官]</span></span>
        ...
        <div class="top-box">
            ...
            <!-- 中间选择游戏部分 -->
             <div class="moreGame" >
                 ...
                 <p class="GameText"><span class="playingMethod" id="playingMethod"></span>赔率:<em class="gamesPrize" id="gamesPrize"></em></p>
                ...
                <div class="PlayCenter">
                    <div class="playControlBox">
                        ...
                        <div class="chooseOKBtn gameMoney fix" >
                            ...
                            <div class="Padding07">
                            注数:<b>注</b><em class="colorEB7A70" id="totalBetCount"></em>
                            <br>
                            总计:<b>元</b><em class="yellow" id="totalBetAmount"></em>
                            <br>
                            最高盈利:<b>元</b><em class="yellow" id="totalWin"></em>
                            <br>
                            余额:<b>元</b>
    ...
    <script src="<?php echo $imgCdnUrl ?>/js/game/min/game_lhc.min.js?v=<?php echo $html_version; ?>" type="text/javascript"></script>
        ...
        window.onload=function(){
            ...
            if(somax > 0){
                ...
                rangeSlider.noUiSlider.on('update', function(value) {
                    ...
                    $('#gamesPrize').html($('#curPrizeSpan option').eq(value).html().split(',')[0]);
