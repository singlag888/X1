...
logdump($_POST);
logdump('=========input===========');
logdump(logdump(file_get_contents('php://input')));
$info = array();
$result =  curlPostData(getRootUrl() . "/?c=pay&a=changchengfuBack", http_build_query($_POST), $info);
echo $result;
