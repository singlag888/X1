...
$result =  curlPostData(getRootUrl() . "/?c=pay&a=huitongBack", $datas, $info);
file_put_contents('huitongBackNotify.log', $datas . "\n", LOCK_EX | FILE_APPEND);
file_put_contents('huitongBackNotify.log', $result . "\n", LOCK_EX | FILE_APPEND);
echo $result;
