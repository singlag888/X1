...
(function($){
    $.fn.dialog = function(settings, wnd){
        ...
        $('body', wnd.document).append('<div id="ui-dialog" style="outline: none 0px;z-index: 9002;width: 14rem;height: 20rem;display: block;left: 1rem;overflow: auto;top: 4rem;" class="ui-dialog" tabindex="-1"><div class="ui-dialog-titlebar"><span class="ui-dialog-title" id="ui-dialog-title"></span></div><div class="ui-dialog-main"><div class="ui-dialog-boxtab"><div class="ui-dialog-content"></div></div><div class="ui-dialog-button ui-helper-clearfix"><div id="ui-dialog-buttonset" class="ui-dialog-buttonset"></div></div></div><div class="ui-dialog-foot"></div></div>');
