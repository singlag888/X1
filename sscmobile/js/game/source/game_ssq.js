...
(function($) {
    ...
    $.init = function(settings) {
        ...
        function todayGetCurIssue(lastIssueInfo){
            ...
            $("#todayIssuesBody").prepend('<ul class="fix"><li style="width:30%">'+'第'+lastIssueInfo.issue+'期'+'</li><li style="width:70%">'+codes+'</li></ul>');
        ...
        var prizeBar = {
            ...
            showPirze: function() {
               if($.isEmptyObject(ps.curMethod) !== true ){
                    ...
                    $("#curPrizeSpan").val(ps.curPrizeIndex);
                    $("#gamesPrize").html('赔率：'+$('#curPrizeSpan').find("option:selected").html().split("/")[0]);
                ...
                if ($("#inputTA").length > 0) {
                    ...
                    for (var i in arr) {
                        ...
                        if (tmp.length != array_unique(tmp).length) {
                            parent.layer.alert("您输入的号码有重复，请重新检查输入",{icon:7,closeBtn: 0},
                                    function(index){
                                    buyBar.layerremoveAll();
                                    layer.close(index);
                                    });
...
//                    }
            ...
            layerremoveAll: function(index) {
                ...
                $(".top-box").addClass("DisplayBlock").removeClass("DisplayNone");
                $("#projectList").empty();
            },
            removeAll: function() {
                $("#token").val("");
                ...
                if (singleNum > 0) {
                    ...
                    $(".selectCodeBtn_selected").click(function(){
                        ...
                        $("#selectCodeBtn").click(function(){
                            if ($("#playingMethod").html() == '红蓝直选单式') {
                                $(".top-box").addClass("DisplayNone").removeClass("DisplayBlock");
                                $(".NumberBox5").addClass("DisplayNone").removeClass("DisplayBlock");
                                $(".moreGame").addClass("DisplayNone").removeClass("DisplayBlock");
                                $(".GameBoxall").addClass("DisplayNone").removeClass("DisplayBlock");
                                $(".betPage").addClass('DisplayBlock').removeClass("DisplayNone");
