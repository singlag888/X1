...
(function($) {
    ...
    $.init = function(settings) {
        ...
        function todayGetCurIssue(lastIssueInfo){
            ...
            $("#todayIssuesBody").prepend(
                '<ul class="fix">' +
                    '<li style="width:40%">' + '第' + lastIssueInfo.issue + '期' + '</li>' +
                    '<li style="width:60%">'+codes+'</li>' +
                '</ul>'
            );
        ...
        var prizeBar = {
            ...
            showPirze: function() {
                if($.isEmptyObject(ps.curMethod) !== true ){
                    ...
                    $('.rebateValue').html($('#curPrizeSpan option').eq(0).html().split('/')[0]);
        ...
        var ballBar = {
            ...
            generateBall: function() {
                ...
                $.each(ps.curMethod.field_def, function(i, prop) {  //注：i从1开始
                    ...
                    // }
                    // if ($.inArray(ps.curMethod.name, ['JDX']) !== -1) {
...
//                    }
            ...
            removeAll: function() {
                ...
                $("#projectList").empty();
                ps.nextProjectCounter = 0;
                $("#multiple").val("");//不显示输入框默认的1注
                buyBar.updateTotalSingle();
                ballBar.reset();
            },
            layerremoveAll: function() {
