                ...
                $.each(ps.curMethod.field_def, function(i, prop) {  //注：i从1开始
                    ...
                    $.each(numList, function(ii, nn) {
                        ...
                        if(ps.curMethod.name === "JSHZ"){
                            if(nn ==='3'||  nn==="18"){
                                oballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img1" disabled="disabled" placeholder=""/><div></li>';
                            } else if(nn ==='4'|| nn === "17"){
                                oballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img2" disabled="disabled" placeholder=""/><div></li>';
                            }else if(nn ==='5'|| nn==="16"){
                                oballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img3" disabled="disabled" placeholder=""/><div></li>';
                            }else if(nn ==='6'|| nn === "15"){
                                oballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img4" disabled="disabled" placeholder=""/><div></li>';
                            }else if(nn ==='7'|| nn==="14"){
                                oballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img5" disabled="disabled" placeholder=""/><div></li>';
                            }else if(nn ==='8'|| nn === "13"){
                                oballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img6" disabled="disabled" placeholder=""/><div></li>';
                            }else if(nn ==='9'|| nn==="12"){
                                oballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img7" disabled="disabled" placeholder=""/><div></li>';
                            }else{
                                oballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img8" disabled="disabled" placeholder=""/><div></li>';
                            }
                            ballStr += oballStr;
                        }else{
                            if(!isNaN(nn)){
                                ballStr += '<li class="jsks ts'+nn+'">' + nn + "</li>";
                            }else if(nn == "三同号通选"){
            ...
            updateSingle: function(singleNum) {
                ...
                if (singleNum > 0) {
                    ...
                    $(".selectCodeBtn_selected").click(function(){
                        $(".NumberBox_k3").addClass("DisplayNone").removeClass("DisplayBlock");
                    ...
                    success: function(response) {
                        if (response.errno == 0) {
                            if(response.kTime != 0)
                            {
                                ...
                                $('#qiehuan_x').attr("href","#");
                                $('#qiehuan_x').attr("onclick","return false");
                                $('#qiehuan_x').css("color","white");
                                var t=response.kTime/1000;
                                $('.GameName').text('');
                                $('#thisIssueNumUL').html("<div style='font-size: 27px;text-align:center;float: left;margin-left: 26%;margin-top:6%;'>休市中...</div>");
