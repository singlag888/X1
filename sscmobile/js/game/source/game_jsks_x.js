    ...
    $.init = function (settings) {
        ...
        var prizeBar = {
            ...
            showPirze: function () {
                if ($.isEmptyObject(ps.curMethod) !== true) {
                    ...
                    var selectedHtm1 =$('#curPrizeSpan option:selected').html();
                    $('.rebateValue_lmlx').html(selectedHtm1.split('/')[0]);
                    $('#rebateValue').html(selectedHtm1.split('/')[1]);
                    $('.ks_img1').attr('placeholder', selectedHtm1.split(',')[0])
                    $('.ks_img2').attr('placeholder', selectedHtm1.split(',')[1])
                    $('.ks_img3').attr('placeholder', selectedHtm1.split(',')[2])
                    $('.ks_img4').attr('placeholder', selectedHtm1.split(',')[3])
                    $('.ks_img5').attr('placeholder', selectedHtm1.split(',')[4])
                    $('.ks_img6').attr('placeholder', selectedHtm1.split(',')[5])
                    $('.ks_img7').attr('placeholder', selectedHtm1.split(',')[6])
                    $('.ks_img8').attr('placeholder', selectedHtm1.replace(/\/\d+\.\d\%/,'').split(',')[7])

                    /* 两面盘 begin */
                    //$('.rebateValueKS-HZDXDS').html(selectedHtm1.split('/')[0]);
                    /* 两面盘 end */

                    if (ps.curMethod.method_id != 360 && ps.curMethod.method_id != 368 && ps.curMethod.method_id != 693) {
                    }
                }
            },
            //保存当前奖金设置
            ...
            $.each(ps.methods,
                function (i, n) {
                    if (n.childs.length == 1) {
                        if (n.mg_name == "二同号单选" || n.mg_name == "二不同号" || n.mg_name == "三不同号") {
        ...
        var methodBar = {
            ...
            selectDefault: function () {
                ...
                var ob = $methodGroupContainer.find("dd:contains('两面盘')");
                if (typeof ob[0] === 'object') {
                    ob.click();
                    $(".GameText span.playingMethod").html(ob.text());
                }else{
        ...
        var ballBar = {
            ...
            generateBall: function () {
                ...
                /* 信用不需要最下边的输入框  begin */
                // if ($.inArray(ps.curMethod.name, ['JSHZ','KS-HZDXDS','JSETFX','JSSTDX','JSSLTX','JSSLTX']) !== -1) {
                //     $("#multiple").show();
                //     $('.important_font_box').show();
                // } else {
                //     $("#multiple").show();
                //     $('.important_font_box').show();
                // }
                ...
                $.each(ps.curMethod.field_def, function (i, prop) {  //注：i从1开始
                    ...
                    $.each(numList, function (ii, nn) {
                        ...
                        if (ps.curMethod.name === "JSHZ") {
                            if (nn === '3' || nn === "18") {
                                ballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img1" disabled="disabled" placeholder=""/></div></li>';
                            } else if (nn === '4' || nn === "17") {
                                ballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img2" disabled="disabled" placeholder=""/></div></li>';
                            } else if (nn === '5' || nn === "16") {
                                ballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img3" disabled="disabled" placeholder=""/></div></li>';
                            } else if (nn === '6' || nn === "15") {
                                ballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img4" disabled="disabled" placeholder=""/></div></li>';
                            } else if (nn === '7' || nn === "14") {
                                ballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img5" disabled="disabled" placeholder=""/></div></li>';
                            } else if (nn === '8' || nn === "13") {
                                ballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img6" disabled="disabled" placeholder=""/></div></li>';
                            } else if (nn === '9' || nn === "12") {
                                ballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img7" disabled="disabled" placeholder=""/></div></li>';
                            } else {
                                ballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="ks_img ks_img8" disabled="disabled" placeholder=""/></div></li>';
                            }
                        }else if(ps.curMethod.name === "KS-HZDXDS"){
                            ballStr += '<li class="lmstyle">和' + nn + '</li>';
                        } else if (ps.curMethod.name === "JSETDX" || ps.curMethod.name === "JSEBT" || ps.curMethod.name === "JSSBT") {
                            ballStr += '<li class="ks_ball ts' + nn + '">' + nn + '</li>';
                        } else {
                            if (!isNaN(nn)) {
                                ballStr += '<li class="ts' + nn + '">' + nn + '</li>';
                            } else if (nn == "三同号通选") {
                                ballStr += '<li class="ts_sthtx">' + nn + '</li>';
                            } else if (nn == "三连号通选") {
                                ballStr += '<li class="ts_sthtx">' + nn + '</li>';
                            }
                        }
                    ...
                    if (ps.lotteryType == 6 && (ps.curMethod.name === "JSETDX" || ps.curMethod.name === "JSEBT" || ps.curMethod.name === "JSSBT")) {
                        ballListName = 'ballList_k3no_square';
                        //$(".confirmBtn_x").hide();
                        // $(".confirmBtn_g").show();
                        // $(".hz_lmlx").show();
                    ...
                    if (ps.lotteryType == 6 && ps.curMethod.name === 'KS-HZDXDS') {
                        ballListName = 'ballList_x';
                    }
                    /* ballListName 样式 end */

                    ballStr = '<li><ul class="' + ballListName + (/(BD|HZ)$/.test(ps.curMethod.name) ? " dice" : "") + '" id=field_' + i + ">" + ballStr + "</ul></li>";
                    hzbdStr = '<li><ul class="BDHZinfo">' + hzbdStr + "</ul></li>";
                    var specialClass = "";
                    if (/(DXDS)$/.test(ps.curMethod.name) && ps.curMethod.name !== 'KS-HZDXDS') {
                    ...
                    if (ps.lotteryType == 6 && (ps.curMethod.name == 'JSSTTX' || ps.curMethod.name == 'JSSLTX')) {
                        ...
                        $('<div class="locate" id="locate_' + i + '"><ul class="lotteryNumber' + specialClass + '">' + ballStr + "</ul></div>").appendTo("#selectArea");
                    }
                    //和值不显示顶部赔率
                    if (ps.curMethod.name == 'JSHZ') {
                         $(".hz_lmlx").hide();
...
//                $(".ballList_k3no_sttx li").bind("click", ballBar.ball_Click);
        ...
        var initBuyBar = function () {
            ...
            $("#confirmBtn_g").click(function () {
                buyBar.confirmBtn_Click_g(0)
            });
...
//                        }
//                    }
                    if (ps.curMethod.method_id == 367 || ps.curMethod.method_id == 700 || ps.curMethod.method_id == 708) {//如果是三连号通选(nyjah)
                ...
                //$(".chooseOKBtnKS").addClass('DisplayBlock');
            ...
            removeAll: function () {
                ...
                $(".txtaddSty_x").val("");
                buyBar.updateTotalSingle();
                $("#field_1 li").removeClass('ball_Selected');
                $(".ks_ball").removeClass('ball_Selected');
                $("#betCount").text(0)
                $("#multiple").val("1");
            },
...
//                 $.each($('.txtaddSty_x'), function (i, item) {
//                     // ps.curMethod.method_id;
...
//                 if (codesx == '三同号通选') {
//                     codesx = "111_222_333_444_555_666";
//                 }
//                 if (codesx == '三连号通选') {
//                     codesx = "123_234_345_456";
//                 }
...
//                                         $(".chooseOKBtnKS").removeClass("DisplayBlock");
//                                         layer.close(index);
//                                     });
...
//             },
            ...
            confirmBtn_Click_g: function (fastBet) {
                ...
                $("#projectList").children("li").each(function (i) {
                    ...
                    methodCodes[$(this).children().eq(0).attr("mid")][i] = $(this).children().eq(1).text().replace(/和/g,'');;
                });
                        ...
                        $.post("?c=game&a=play", {
                            ...
                            function (response) {
                                if (response.errno == 0) {
                                    ...
                                    //奖池玩法刷新
                                    buyBar.removeAll();
                                    var msg = '<div id="buy_success_message">购买成功!<br>************************<br>订单编号：' + response.pkgnum + "<br>玩法：<span>" + ps.curMethod.cname + "</span><br>投注期号：" + ps.curIssueInfo.issue + "<br>内容：" + codesg + "<br>注数：" + betTotalBetCount + "注<br>投注总额：￥" + betTotalAmount + "<br>************************<br></div>";
                                    parent.layer.alert(msg, {icon: 1});
                                    parent.layer.alert(msg, {icon: 1}, function (index) {
                                        $(".chooseOKBtnKS").removeClass("DisplayBlock");
                                        layer.close(index);
