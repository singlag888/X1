        ...
        var prizeBar = {
            ...
            showPirze: function showPirze() {
                if ($.isEmptyObject(ps.curMethod) !== true) {
                    ...
                    $('.pks_img1').attr('placeholder', selectedHtm1.split(',')[0]);
                    $('.pks_img2').attr('placeholder', selectedHtm1.split(',')[1]);
                    $('.pks_img3').attr('placeholder', selectedHtm1.split(',')[2]);
                    $('.pks_img4').attr('placeholder', selectedHtm1.split(',')[3]);
                    $('.pks_img5').attr('placeholder', selectedHtm1.replace(/\/\d+\.\d\%/, '').split(',')[4]);
                }
            },
                    ...
                    $.each(numList, function (ii, nn) {
                        ...
                        if (ps.curMethod.name === "PKS-GYHZ") {
                            if (nn === '03' || nn === "04" || nn === "18" || nn === "19") {
                                oballStr += '<li>' + nn + '<div class="pks_prizeList"><input class="pks_img pks_img1" disabled="disabled" placeholder=""/><div></li>';
                            } else if (nn === '05' || nn === "06" || nn === "16" || nn === "17") {
                                oballStr += '<li>' + nn + '<div class="pks_prizeList"><input class="pks_img pks_img2" disabled="disabled" placeholder=""/><div></li>';
                            } else if (nn === '07' || nn === "08" || nn === "14" || nn === "15") {
                                oballStr += '<li>' + nn + '<div class="pks_prizeList"><input class="pks_img pks_img3" disabled="disabled" placeholder=""/><div></li>';
                            } else if (nn === '09' || nn === "10" || nn === "12" || nn === "13") {
                                oballStr += '<li>' + nn + '<div class="pks_prizeList"><input class="pks_img pks_img4" disabled="disabled" placeholder=""/><div></li>';
                            } else {
                                oballStr += '<li>' + nn + '<div class="pks_prizeList"><input class="pks_img pks_img5" disabled="disabled" placeholder=""/><div></li>';
                            }
                        } else {
                            oballStr += '<li>' + nn + "</li>";
                        }
