...
(function ($) {
    $.init = function (settings) {
        ...
        function todayGetCurIssue(lastIssueInfo) {
            ...
            $("#todayIssuesBody").prepend('<ul class="fix"><li style="width:35%">' + '第' + lastIssueInfo.issue + '期' + '</li><li style="width:65%">' + codes.join('') + '</li></ul>');
        ...
        var prizeBar = {
            ...
            showPirze: function showPirze() {
                if ($.isEmptyObject(ps.curMethod) !== true) {
                    ...
                    // 冠亚和值大小单双
                    if (ps.curMethod.name === "PKS-GYDXDS") {
        ...
        var methodBar = {
            ...
            selectDefault: function selectDefault() {
                $("#methodGroupContainer").find("li:contains('前五定位胆')").click();
                $(".playNav ul ul").hide();
            }
        };
            ...
            generateBall: function generateBall() {
                ...
                $.each(ps.curMethod.field_def, function (i, prop) {
                    ...
                    $.each(numList, function (ii, nn) {
                        ...
                        if (ps.curMethod.name === "PKS-GYHZ") {
                            if (nn === '03' || nn === "04" || nn === "18" || nn === "19") {
                                oballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="rebateValue_pks rebateValue1_1" disabled="disabled" placeholder=""></div></li>';
                            } else if (nn === '05' || nn === "06" || nn === "16" || nn === "17") {
                                oballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="rebateValue_pks rebateValue1_2" disabled="disabled" placeholder=""></div></li>';
                            } else if (nn === '07' || nn === "08" || nn === "14" || nn === "15") {
                                oballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="rebateValue_pks rebateValue1_3" disabled="disabled" placeholder=""></div></li>';
                            } else if (nn === '09' || nn === "10" || nn === "12" || nn === "13") {
                                oballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="rebateValue_pks rebateValue1_4" disabled="disabled" placeholder=""></div></li>';
                            } else {
                                oballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="rebateValue_pks rebateValue1_5" disabled="disabled" placeholder=""></div></li>';
                            }
                        } else if (ps.curMethod.name === 'PKS-GYDXDS') {
                            oballStr += '<li>' + nn + '<div class="ks_prizeList"><input class="rebateValue_pks rebateValueGYDXDS" disabled="disabled" placeholder=""></div></li>'; //号码球结构
                            // } else {
                            ...
                            oballStr += '<li>' + nn + '</li>'; //号码球结构
                            // $(".confirmBtn_x").show();
                            // $(".confirmBtn_g").hide();
                        }
                        // }
                        if ($.inArray(ps.curMethod.name, ['PKS-GYDXDS', 'PKS-GYHZ', 'PKS-GYHZ']) !== -1) {
                            $(".hz_lmlx").hide();
                        } else {
                            $(".hz_lmlx").show();
                        }
                    ...
                    if (/(DXDS)$/.test(ps.curMethod.name)) {
                        specialClass = ' DXDS-margin-left dice';
        ...
        var buyBar = {
            ...
            selectCodeBtn_Click: function selectCodeBtn_Click() {
                ...
                if ($("#inputTA").length > 0) {
                    ...
                    buyBar.updateTotalSingle();
                    //ballBar.reset();//点击取消按钮的时候不清空号码球的颜色
                    //$("#confirmBtn").removeClass('CantapCodeBtn');
                }
            ...
            confirmBtn_Click: function confirmBtn_Click(fastBet) {
                ...
                $('.multiple1').each(function (i, item) {
                    if (/^[1-9]*[1-9][0-9]*$/.test($(item).val())) {
                        ...
                        if (ps.curMethod.name == 'PKS-DWD' || ps.curMethod.name == 'PKS-DWDH5') {
                        ...
                        } else if (ps.curMethod.name === 'PKS-Q5LM' || ps.curMethod.name === 'PKS-H5LM') {
                            // 有一个隐藏域需要跳过
                            if (i >= 20) {
                                return false;
                            }
                            ...
                            codes += ','.repeat(i / 4) + $betBall + '+' + $value + ','.repeat((19 - i) / 4) + '|';
                        } else {
                            codes += $(item).data('ball').toString() + '+' + $(item).val() + '|';
                        }
        ...
        var drawBar = {
                                ...
                                if (response.kTime != 0) {
                                    ...
                                    if (typeof response.issueInfo.code != "undefined") {
                                        ...
                                        if ($("#todayDrawBtn").hasClass("cur")) {
                                            ...
                                            var str = '<ul class="fix"><li style="width:35%">' + v.issue + '</li><li style="width:65%"><b>' + arr + "</b></li>";
            ...
            todayDrawBtn_Click: function todayDrawBtn_Click() {
                ...
                $.each(ps.todayDrawList, function (k, v) {
                    ...
                    if (ps.lotteryType == 8) {
                        var arr = splitCode2.split(" ").join("</b><b>");
                        var str = '<ul class="fix"><li style="width:35%">' + '第' + v.issue + '期' + '</li><li style="width:65%"><b>' + arr + "</b></li>";
                    } else {
                        throw exception('unknown lt type');
                    }
