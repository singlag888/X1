...
(function ($) {
    ...
    $.init = function (settings) {
        ...
        var initPrizeBar = function initPrizeBar() {
            ...
            if (ps.lotteryType == 1) {
                //如果是SSC 初始化时把大于1950的干掉
                $.each(ps.rebateGapList, function (k, v) {
                    if (ps.lotteryId == 10 && v.prize > 1920) {
                        //如果是3D 大于1920的干掉
            ...
            showPirze: function showPirze() {
                if ($.isEmptyObject(ps.curMethod) !== true) {
                    ...
                    $.each(ps.rebateGapList, function (k, v) {
                        ...
                        if (ps.property_id == 1 && ps.rebateGapList[k].prize > 1950) {
                            //如果时时彩奖金组大于1950的就不显示
                            return true;
                        }

                        if (ps.property_id == 2 && ps.rebateGapList[k].prize > 1901) {
                            //如果115奖金组大于1901的就不显示
                            return true;
                        }

                        if (ps.property_id == 5 && ps.rebateGapList[k].prize > 1920) {
                            //如果3D P3P5奖金组大于1920的就不显示
                            return true;
                        }

                        if (ps.property_id == 6 && ps.rebateGapList[k].prize > 1404) {
                            //如果pk拾 奖金组大于1404的就不显示
                            return true;
                        }
                ...
                if (ps.lastIssueInfo.issue == latest.issue) {
                    ...
                    if (ps.lotteryType == 6) {
                        ...
                        $.each($("#thisIssueNumUL").children(), function (i, n) {
                            ...
                            if ($("#pendingText").hasClass("active")) {} else {
                                $("#pendingText").addClass("active");
                                $("#pendingText").removeClass("hidden");
                                $(".GameNuberFont").addClass("hidden");
                                $(".GameNuberFont").removeClass("active");
