...
<html>
    ...
    <body>
        ...
        <header id="firstHeader" class="headerbg">
            ...
            <span class="headtetle"><?php echo $lottery['cname'] ?><span class="title_x">[官]</span></span>
                ...
                <div class="PlayCenter">
                    <div class="playControlBox">
                        ...
                        <div class="FatherCodeBtn01">
                                    <select id="curPrizeSpan" class="f-left" style="display: none;"></select>
    ...
    <script type="text/javascript" src="<?php echo $imgCdnUrl ?>/js/game/min/game_xy28.min.js?v=<?php echo time(); ?>" type="text/javascript"></script>
