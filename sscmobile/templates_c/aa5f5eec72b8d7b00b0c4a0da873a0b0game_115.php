...
<html>
    ...
    <title><?php echo config::getConfig('site_title'); ?></title>
        ...
        <style type="text/css">html,body{width: 100%;height: 100%;    position: absolute;}
        ...
        <div class="top-box">
            ...
            <!-- 中间选择游戏部分 -->
             <div class="moreGame" >
                ...
                <button class="paright" id="moreGame">更多玩法<img src="<?php echo $imgCdnUrl ?>/images/mobile/arrows_right_02.png"/></button>
             </div>
    ...
    <script src="<?php echo $imgCdnUrl ?>/js/game/min/game_115.min.js?v=<?php echo time(); ?>" type="text/javascript"></script>
    <script type="text/javascript">
        <?php $this->import("default_Df"); ?>
        $(function() {
            var methods = <?php echo $methods ?>;
            $.init({
                lotteryId: <?php echo $lottery['lottery_id']; ?>, lotteryName: '<?php echo $lottery['cname']; ?>[官]', property_id:<?php echo $lottery['property_id']; ?>, prizeRate: <?php echo 1 - $lottery['total_profit']; ?>, lotteryType: <?php echo $lottery['lottery_type']; ?>, methods: methods[<?php echo $lottery['lottery_id'] ?>], maxCombPrize: <?php echo $maxCombPrize; ?>, openedIssues: <?php echo $json_openedIssues; ?>, minRebateGaps: <?php echo $minRebateGaps; ?>, rebate: <?php echo $rebate; ?>, defaultMode: 1, defaultRebate: <?php echo $rebate; ?>, missHot: <?php echo $json_missHot; ?>
            });
        });
        ...
        $(document).ready(function(){
            ...
            window.onload=function(){
                ...
                if(somax > 0){
                    ...
                    $("#gamesPrize").html('')
                    $('.syxw_dds_1').attr('placeholder',selectedHtm2.split(',')[0]);
                    $('.syxw_dds_2').attr('placeholder',selectedHtm2.split(',')[1]);
                    $('.syxw_dds_3').attr('placeholder',selectedHtm2.split(',')[2]);
                    $('.syxw_dds_4').attr('placeholder',selectedHtm2.split(',')[3]);
                    $('.syxw_dds_5').attr('placeholder',selectedHtm2.split(',')[4]);
                    $('.syxw_dds_6').attr('placeholder',selectedHtm2.replace(/\/\d+\.\d+\%/,'').split(',')[5])
                }else if($('#playingMethod').html() == '猜中位'){
                    $("#gamesPrize").html('')
                    $('.syxw_dds1_1').attr('placeholder',selectedHtm2.split(',')[0]);
                    $('.syxw_dds1_2').attr('placeholder',selectedHtm2.split(',')[1]);
                    $('.syxw_dds1_3').attr('placeholder',selectedHtm2.split(',')[2]);
                    $('.syxw_dds1_4').attr('placeholder',selectedHtm2.replace(/\/\d+\.\d+\%/,'').split(',')[3]);
                }else{
