...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $imgCdnUrl ?>/css/mobile_overallStyle_x.css?v=<?php echo $html_version; ?>">
    <style type="text/css">
        html, body {
            width: 100%;
            height: 100%;
...
<?php else: ?>
    ...
    <header id="firstHeader" class="headerbg">
        <a class="headbox01" href="?c=game&a=lobby">游戏大厅</a><!-- <b class="title_x">信</b> -->
        <!--<span class="headtetle">极速⑥合彩<span class="title_x">[信]</span></span>-->
        <span class="headtetle">极速⑥合彩[信]</span>
        ...
        <!--下拉菜单-->
        <div class="icon-list" style="margin-top: 1rem;display: none;top:0.86rem;">
...
<div class="top-box">
        ...
        <div class="playTimer thisIssueInfo" id="thisIssueInfo">
            ...
            <span class="Timer fix">
                    <div class="thisIssueRemainTime"
                         id="thisIssueRemainTime"><span>00</span><em>:</em><span>00</span><em>:</em><span>00</span>
                    </div>
            </span>
        </div>
    </div>
    ...
    <div class="moreGame">
        ...
        <p class="GameText"><span class="playingMethod" id="playingMethod"></span><b class="hz_lmlx"
                                                                                     style="display: none;">赔率：<b
    ...
    <div class="Gamepart">
        <div class="subTopBar">
            ...
            <div class="playToolTipBox DisplayNone">
                <div class="playNav">
                    <ul class="lotteryTab xynewmenu" id="methodGroupContainer">
...
<div>
    ...
    <div class="FatherCodeBtn01">
        <!--<a href="?c=game&a=lhc" class="qiehuan_g">切换官方</a>-->
        ...
        <div class="xfootbox02">
            ...
            <div class="btnGroup" style="display: inline-block">
                <input id="multiple" name="multiple" class="injine_x" maxlength="5" type="number" pattern="[0-9]*">
            </div>
            <!-- <button class="confirmBtn_x" id="confirmBtn">投注</button> -->
            <button class="confirmBtn_g" id="selectCodeBtn">投注</button>
            <button id="confirmBtn_g" style="display: none;">投注</button>
        </div>
    </div>
</div>
<div class="betPage DisplayNone">
    ...
    <div class="chooseOKBtn gameMoney fix" style="display: none;">
        <div class="fl">
...
<!--滑动插件-->
<script type="text/javascript" src="<?php echo $imgCdnUrl ?>/js/qiehuangame.js?v=<?php echo $html_version; ?>"></script><!--切换-->
...
<script src="<?php echo $imgCdnUrl ?>/js/game/min/game_jslhc_x.min.js?v=<?php echo time(); ?>" type="text/javascript"></script>
        ...
        window.onload = function () {
            ...
            if (somax > 0) {
                ...
                rangeSlider.noUiSlider.on('update', function (value) {
                    ...
                    $('.rebateValue_lmlx').html($('#curPrizeSpan option').eq(value).html().split('/')[0].replace('一等奖:', '').replace('二等奖:', '').replace(';', '/'));
                    $('.rebateValue1').attr('placeholder', selectedHtm2.split('/')[0]);
                    $('.rebateValue2').attr('placeholder', selectedHtm2.replace("一等奖:", '').split(';')[0]);
                    $('.rebateValue3').attr('placeholder', selectedHtm2.split('/')[0].split(':')[2]);
                    $('#curPrizeSpan').change();
                });
            } else {
                $('#selectRebate').hide();
