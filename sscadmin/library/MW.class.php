...
class MW
{
    ...
    public function transfer($asinTransferOrderNo, $asinTransferOrderTime, $transferAmount, $transferOrderNo, $temp_id, $temp_username)
    {
        $uid = $temp_id;
        $uid = $this->siteId . '_' . $this->merchantId. '_' . $uid;
    ...
    public function transferOut($asinTransferOrderNo, $asinTransferOrderTime, $transferAmount, $transferOrderNo, $temp_uid, $temp_username)
    {
        $uid = $temp_uid;
        $uid = $this->siteId . '_' . $this->merchantId. '_' . $uid;
        $username = $temp_username;
