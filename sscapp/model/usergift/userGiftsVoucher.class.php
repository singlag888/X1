...
class userGiftsVoucher extends userGiftsBase implements userGiftsInerface
{
    ...
    {
        $html = '<a href="index.jsp?&c=user&a=userGifts&giftType=voucher" target="_blank" class="topLinkBtn">现金礼券白送啦</a>';
    ...
    {
        $html = '<div id="FloatAD" class="ADBox"><a href="index.jsp?&c=user&a=userGifts&giftType=voucher" target="_blank"><img src="images/sign/float.png" width="180" height="185"></a><span onclick="document.getElementById(\'FloatAD\').style.display=\'none\';" class="ADcloser"></span></div>';
    ...
    {
        $html = '<li style="background: url(images/sign/qiandaobanner.jpg) no-repeat center top"><a href="index.jsp?&c=user&a=userGifts&giftType=voucher&alert=1" target="_blank">voucher</a></li>';
