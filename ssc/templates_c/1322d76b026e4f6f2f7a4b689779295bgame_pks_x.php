...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $imgCdnUrl ?>/css/game_bjpks_x.css?v=<?php echo $html_version; ?>" />
    <?php $this->import('public_cssjs') ?>
    	<style type="text/css">
			#quickSelect{float: right;margin-right: 29px;display: inline-block; margin-left: 10px;width: 140px;height: 32px;line-height: 32px;background:#e4393c;color: #fff;text-align: center;border-radius: 3px;font-size: 17px;}
    	    ...
    	    #choPirze{margin: 5px 110px 10px 15px;width: 600px;}
    	    .totalcont{margin-left: 290px;}
            .moneySlide{width: 758px;}
    	</style>
</head>
<body class="BodyMain">
    <!-- 背景层开始 -->
        ...
        <div class="Gamepart">
            <div class="bjpkstopBox">
                ...
                <div class="bjpkLottCont fix">
                    ...
                    <a class="trendBtn" href="?c=game&a=chart&lottery_id=<?php echo $lottery['lottery_id']; ?>" target="_blank">
                        <span></span>
                        <label>开奖走势图</label>
                    </a>
                            ...
                            <div class="fl choPirze" id="choPirze">
                                <ul class="prize_list">
                                    ...
                                    <div class="gameLeftLI" id="singleInfo">
                                            ...
                                            <input id="multiple"   name="multiple" class="multiple" maxlength="5"/>
                                        </div>
                                </ul>
    ...
    <script src="<?php echo $imgCdnUrl ?>/js/ext.js?v=<?php echo $html_version; ?>" type="text/javascript"></script>
    <script src="<?php echo $imgCdnUrl ?>/js/game/min/game_pks_x.min.js?v=<?php echo $html_version ?>" type="text/javascript"></script>
