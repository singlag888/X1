...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo $imgCdnUrl ?>/css/game_k3.css?v=<?php echo $html_version ?>" />
     ...
     <div class="tz_nr">
        <div class="NumberBox_k3 NumberBox5 fix">
            ...
            <div class="LottLeft">
                ...
                <hr>
                <div class="openChart">
                    <a class="chart" target="_blank" href="index.jsp?c=game&a=chart&lottery_id=<?php echo $lottery['lottery_id']; ?>">开奖走势图</a>
                </div>
            </div>
            <div class="Lottmain">
                <div class="GameName">
                    ...
                    <div class="playControlBox">
                        ...
                        <div class="chooseOKBtn gameMoney fix" >
                                ...
                                <div class="moneySlide">
                                    ...
                                    <div class="SingleInfo" id="totalSingleInfo">
                                        <div class="multipleNumber">
                                            <span class="fl">倍数</span>  
                                            <span id="minusBtn" type="button" class="minusBtn" style="padding:2px 8px">-</span><input value="1" id="multiple" name="multiple" class="txtStyle txtaddSty" maxlength="5"/><span id="plusBtn" type="button" class="plusBtn" style="padding:2px 8px" >+</span>
                                        </div>
                            ...
                            <div class="totalcont fix">
                                <div class="totalText">总注数：<em id="totalBetCount">0</em>注, 总金额：<em id="totalBetAmount"></em>元, 盈利￥<em id="totalWin">0.00</em>(默认最高奖金盈利)</div>
                                <div class="totalBtn">
...
<?php $this->import('public_foot') ?>
    ...
    <script type="text/javascript" src="<?php echo $imgCdnUrl ?>/js/layer-v2.4/layer.js?v=<?php echo $html_version_num; ?>"></script> <!-- 调用弹出层 -->
    ...
    <script src="<?php echo $imgCdnUrl ?>/js/game/min/game_jsks.min.js?v=<?php echo time(); ?>" type="text/javascript"></script>
