...
<!--        ==================================视频播放加载js css部分  end========================================================-->
                            ...
                            $(function () {
                                ...
                                $('.video_button').click(function () {
                                    ...
                                    if(live_type=='http'){
                                        ...
                                        var obj='<video id="example_video_1" class="video-js vjs-default-skin vjs-big-play-centered" controls preload="none" width="600" height="350" data-setup="{}">' +
                ...
                <div class="PlayCenter">
                    <div class="playControlBox">
                        ...
                        <div class="chooseOKBtn gameMoney fix" >
                           ...
                           <div class="fr prizeQuestion" style="width:415px">
                               <div class="bonusSlide fix">
                                   <span>奖金/返点</span>
                                   <div id="selectRebate" class="selectRebate"></div>
                                   <span id="rebateValue" class="rebateValue"></span>
                               </div>
                               <i class="question ShowTips methodTipInfo lhcQuestion" id="methodTipInfo" title="">
                                   玩法介绍<label>?</label>
    ...
    <script src="<?php echo $imgCdnUrl ?>/js/game/min/game_lhc.min.js?v=<?php echo time(); ?>" type="text/javascript"></script>
