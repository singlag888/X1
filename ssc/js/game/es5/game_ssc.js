            ...
            generateBall: function () {
                ...
                $.each(ps.curMethod.field_def, function (i, prop) {
                    ...
                    if (ps.curMethod.cname === "定单双") {
                        ...
                        prizeStr += '<li class="ballPrize1_1"></li>' + '<li class="ballPrize1_2"></li>' + '<li class="ballPrize1_3"></li>' + '<li class="ballPrize1_4"></li>' + '<li class="ballPrize1_3"></li>' + '<li class="ballPrize1_2"></li>' + '<li class="ballPrize1_1"></li>';
                    }
