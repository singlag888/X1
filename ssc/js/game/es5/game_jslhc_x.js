    ...
    $.init = function (settings) {
        ...
        var prizeBar = {
            ...
            showPirze: function showPirze() {
                if ($.isEmptyObject(ps.curMethod) !== true) {
                    ...
                    var $fun = function $fun($curPrizeSpan) {
        ...
        var initMethodBar = function initMethodBar() {
            ...
            $.each(ps.methods, function (i, n) {
                ...
                var div = '';
                if (i == 0) {
                    div = $('<div id="method_' + i + '" class="methodControl"></div>').addClass('methodPopStyle');
                } else {
                    ...
                    $.each(numList, function (ii, nn) {
                        switch (ps.curMethod.name) {
                            ...
                            case 'ZTYM':
                                ...
                                ballStr += '<li>' + '<span class="' + ballClass + '">' + nn + '</span><b class="rebateValue1"></b>' + '<input type="text" list="itemlist" name="multiple" class="f-left form-control" maxlength="5" data-ball="' + nn + '" /></li>';
