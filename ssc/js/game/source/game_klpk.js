...
(function($) {
    ...
    $.init = function(settings) {
        ...
        function todayGetCurIssue(lastIssueInfo){
            ...
            if(ps.lotteryType != 2){
                var str = '<ul class="fix"><li style="width:40%;">' + v.issue + '</li><li >' +  drawBar.getMoreInfo(v.code).pkzt  + '</li><li class="width_poker">' +  drawBar.pokerOpenCode(v.code)+ "</li></ul>";
                    ...
                    $.each(numList, function(ii, nn) {
                        switch (ps.curMethod.name) {
                            ...
                            case 'PKTH':    //扑克.同花
                                ...
                                ballStr += '<li class="' + eval('poker_trans.'+nn) + '"><div zhuma="' + nn + '"><em></em><span>'+nn+'</span><i class="gou"></i></div></li>';
                                break;
                            case 'PKTHS':    //扑克.同花顺
                                //需要把玩法设定投注球的名称翻译成对应的class
        ...
        var drawBar = {
            ...
            showCurIssue_Timer: function() {
                ...
                if (ps.curRemainTime >= 0) {
                    ...
                    $('#selectCodeBtn').css('bacground','#f13131')
                    //追号
                    ...
                    $('#selectCodeBtnFast').css('background','#f13131').css('box-shadow','0 2px 2px #D21E2F');
                    //清空按钮
                            ...
                            if (response.errno == 0) {
                                if(response.kTime != 0)
                                {
                                    ...
                                    if (typeof (response.issueInfo.code) != "undefined") {
                                        ...
                                        if ($("#todayDrawBtn").hasClass("todayDrawBtn")) {
                                            var v = ps.todayDrawList[0];
                                            if (ps.lotteryType == 1) {
                                                var str = '<ul><li class="width80px">' + v.issue + '</li><li class="width60px">' + v.code + '</li><li class="width53px">' + v.prop.qszt + '</li><li class="width53px">' + v.prop.hszt + "</li></ul>";
                                            } else if (ps.lotteryType == 2) {
            ...
            todayDrawBtn_Click: function() {
                ...
                if (ps.lotteryType == 1) {
                    ...
                    $("#todayIssuesHead").html('<li class="wb40">期号</li><li class="wb60">形态</li>');
                }
                else {
                ...
                $.each(ps.todayDrawList,
                        function(k, v) {
                            ...
                            if (ps.lotteryType == 1) {
                                var str = '<ul class="fix"><li style="width:40%;">' + v.issue + '</li><li style="width:60%;">' + splitCode + "</li></ul>";
                            } else if (ps.lotteryType == 2) {
                                var arr = splitCode2.split(" ").join("</b><b>");
                                var str = '<ul class="fix1"><li style="width:40%;">' + v.issue + '</li><li style="width:60%;"><b>' + arr + "</b></li></ul>";
                            }
                            else if (ps.lotteryType == 4) {
                                var str = '<ul class="fix"><li style="width:40%;">' + v.issue + '</li><li style="width:60%;">' + splitCode + "</li></ul>";
                            }
                                ...
                                var tmp = v.code.split("");
                                var hz = parseInt(tmp[0]) + parseInt(tmp[1]) + parseInt(tmp[2]);
                                var str = '<ul class="fix"><li style="width:40%;">' + v.issue + '</li><li style="width:60%;">' + v.code + "</li></ul>";
                            }
                            else if (ps.lotteryType == 7) {
                                var str = '<ul class="fix"><li style="width:40%;">' + v.issue + '</li><li>' +  drawBar.getMoreInfo(v.code).pkzt  + '</li><li class="width_poker">' +  drawBar.pokerOpenCode(v.code)+ "</li></ul>";
                            }
