...
(function($) {
    ...
    $.init = function(settings) {
        ...
        var verifyParams = function() {
            ...
            else if (settings.lotteryType == undefined || !is_numeric(settings.lotteryType) || $.inArray(settings.lotteryType, [1]) == -1) {
                flag = -3;
            }
        ...
        var ps = $.extend({
            ...
            lastOpenIssueInfo: {}, //已开奖的上一期{ issue="20130201-070", code="96983"}
        ...
        function todayGetCurIssue(lastIssueInfo){
            ...
            if($("#todayIssuesBody ul:first li:first").html() != lastIssueInfo.issue){//防止重复添加奖期
