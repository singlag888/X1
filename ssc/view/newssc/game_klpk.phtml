...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo $imgCdnUrl ?>/css/game_poker_klpk.css?v=<?php echo $html_version ?>" />    
...
<div class="tz_nr">
            <div class="NumberBox5">
                <div class="Prizepool">
                    <div class="cz_logo"><img src="<?php echo $imgCdnUrl?>/images/lottery_logo_<?php echo $lottery['lottery_id'] ?>.png" alt="<?php echo $lottery['cname']; ?>"></div>
                    <h3><?php echo $lottery['cname']; ?></h3>
                ...
                <div class="playTimer thisIssueInfo" id="thisIssueInfo">
                    <p class="thisIssue">
                        <span class="issue thisIssueDIV">第<span id="thisIssueSpan" class="thisIssueSpan"></span>期</span><span id="thisIssueTimerIcon" class="clock" style="color:#f54444"></span>
                    </p>
                ...
                <div class="PlayCenter">
                    <div class="playControlBox">
                        ...
                        <div class="FatherCodeBtn fix">
                            ...
                            <?php if (in_array($lottery['lottery_id'], array(1, 3, 4, 8, 11))): ?>
                                <input type="button" value="机选10注" num="10" class="selectRandomBtn1 secondBtn" style="background:#0da009">
                            <?php endif;?>
                        </div>
                        <div class="chooseOKBtn gameMoney fix" >
                           ...
                           <div class="fl multipleTotal" id="totalSingleInfo">
                               <div style="height: 25px;margin-bottom: 8px;line-height:25px" >
    ...
    <script src="<?php echo $imgCdnUrl ?>/js/game/min/game_klpk.min.js?v=<?php echo time(); ?>" type="text/javascript"></script>
