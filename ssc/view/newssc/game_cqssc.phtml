...
<div class="tz_nr">
            <div class="NumberBox5">
                ...
                <div class="Lottmain">
                    ...
                    <div class="lotteryNum GameNuberFont thisIssueNumUL-ssc" id="thisIssueNumUL"></div>
    ...
    <script type="text/javascript" src="<?php echo $imgCdnUrl ?>/js/game/min/game_ssc.min.js?v=<?php echo $html_version ?>"></script>
