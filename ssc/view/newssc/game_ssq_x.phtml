...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo $imgCdnUrl ?>/css/all_LightBlue_x.css?v=<?php echo time(); ?>" />
            ...
            <div class="Gamepart">
                ...
                <div class="PlayCenter">
                    <div class="playControlBox">
                        ...
                        <div class="bonusSlide bonusSlideSSQ fix">
                            <span>赔率:</span>
                        ...
                        <div class="chooseOKBtn gameMoney fix" style="border-top:1px dashed #999" >
<!--                            <hr>-->
...
<!--                                <span class="moneyMode"><a href="javascript:void(0);" id="yuan">2元</a><a href="javascript:void(0);" id="jiao">2角</a><a href="javascript:void(0);" id="fen">2分</a><br/><a href="javascript:void(0);" id="yuanYi">1元</a><a href="javascript:void(0);" id="jiaoYi">1角</a><a href="javascript:void(0);" id="li">2厘</a></span>-->
                            ...
                            <div class="fr prizeQuestion">
                                ...
                                <div class="fl multipleTotal" id="totalSingleInfo">
                                    <div style="height: 25px;margin-bottom: 8px;line-height:25px" >
                                        <span class="fl">投注金额：</span><!--<span id="minusBtn" type="button" class="minusBtn" >-</span>--><input value="" placeholder="投注金额" id="multiple" name="multiple" class="txtStyle txtaddSty" maxlength="5"/><!--<span id="plusBtn" type="button" class="plusBtn" >+</span>-->
                                    </div>
                                </div>
                           ...
                           <div class="fl multipleTotal" id="totalSingleInfo">
                               <div style="height: 25px;margin-bottom: 8px;display: none;">
