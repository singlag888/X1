<?php
logdump($_GET);
//preg_match('/\((.*)\)/s', $_GET, $str);
//$str = json_encode(end($str));
//$str = trim("{".mb_substr(str_replace('\'','"',str_replace(' ','',str_replace('\r\n','',str_replace('=>',':',$str)))),1,-2)."}");
//$str = json_decode($str,true);
$result =  curlPostData(getRootUrl() . "/?c=pay&a=sankBack", http_build_query($_GET), $info);
echo $result;
