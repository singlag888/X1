...
logdump($_GET);
$info = array();
//$result =  curlPostData(getRootUrl() . "/?c=pay&a=yiaiBack", http_build_query($_POST), $info);
$result =  curlPostData(getRootUrl() . "/?c=pay&a=yiaiBack", http_build_query($_GET), $info);
echo $result;
//echo $result1;
//exit;
