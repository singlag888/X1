...
logdump($headers);
$info = array();
$result =  curlPostData(getRootUrl() . "/?c=pay&a=F86Back", $data, $info, $headers);
echo $result;
...
function curlPostData($url, $data, &$info, $headers)
{
    // 模拟提交数据函数
    ...
    curl_setopt($curl, CURLOPT_HTTPHEADER, array(
            ...
            'x-oapi-sign: ' . $headers["x-oapi-sign"],
            'x-oapi-sm: ' . $headers["x-oapi-sm"],)
    );
